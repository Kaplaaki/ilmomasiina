...
import { editableSignupAttributes, ownerDynamicSignupAttributes, signupIdentity } from "../signup/attributes";

// This is here because it depends on quota, causing an import cycle.
/** Schema for fetching a signup for editing. */
export const signupForEdit = Type.Interface([signupIdentity, editableSignupAttributes, ownerDynamicSignupAttributes], {
  quota,
